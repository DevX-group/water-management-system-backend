...
public class MessagePlaceholderService {
        ...
        public String replacePlaceholders(String template, Customer customer, Bill currentBill) {
                return replacePlaceholders(template, customer, currentBill, null, null);
        }
        ...
        // Takes a template string and replaces placeholders with actual values from the
        // relevant customer, bill, payment, and optional bank slip.
        public String replacePlaceholders(String template,
                ...
                values.put(MessagePlaceholder.PAYMENT_METHOD.getKey(),
                                safe(payment != null && payment.getPaymentMethod() != null
                                                ? payment.getPaymentMethod().name()
                                                : null));
                values.put(MessagePlaceholder.PAYMENT_ID.getKey(),
                                safe(payment != null ? payment.getPaymentId() : null));

                values.put(MessagePlaceholder.BANK_SLIP_UPLOAD_DATE_TIME.getKey(),
                                formatDateTime(bankSlip != null ? bankSlip.getUploadedAt() : null));
                values.put(MessagePlaceholder.BANK_SLIP_REVIEW_DATE_TIME.getKey(),
                                formatDateTime(bankSlip != null ? bankSlip.getReviewedAt() : null));
