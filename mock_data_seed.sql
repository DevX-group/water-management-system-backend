...
-- Data for Customer SK-2341
INSERT INTO meter_readings (subscription_number, meter_number, previous_reading, current_reading, usage_units, reading_date)
VALUES ('SK-2341', 'MTR-1001', 1000, 1150, 150, CURRENT_DATE);

INSERT INTO meter_readings (subscription_number, meter_number, previous_reading, current_reading, usage_units, reading_date)
VALUES ('SK-2341', 'MTR-1001', 850, 1000, 150, CURRENT_DATE - INTERVAL '1 month');

INSERT INTO meter_readings (subscription_number, meter_number, previous_reading, current_reading, usage_units, reading_date)
VALUES ('SK-2341', 'MTR-1001', 710, 850, 140, CURRENT_DATE - INTERVAL '2 months');
...
VALUES ('SK-2341', 'Bill Generated', 'Your monthly bill for this month is ready.', false, CURRENT_TIMESTAMP, 'MONTHLY_BILL');
...
INSERT INTO notifications (subscription_number, title, message, read_status, created_at, notification_type)
VALUES ('SK-2341', 'Bank Slip Approved', 'Your recent bank slip submission was approved.', false, CURRENT_TIMESTAMP, 'BANK_SLIP_APPROVED');
...
VALUES (gen_random_uuid(), 'SK-2341', 1500.00, 'FULL', 'MONTHLY', 'ONLINE', CURRENT_TIMESTAMP - INTERVAL '5 days');

INSERT INTO payments (payment_id, subscription_number, amount, status, payment_type, payment_method, created_at)
VALUES (gen_random_uuid(), 'SP-4589', 2100.00, 'PENDING', 'OUTSTANDING', 'BANK_TRANSFER', CURRENT_TIMESTAMP - INTERVAL '2 hours');

INSERT INTO payments (payment_id, subscription_number, amount, status, payment_type, payment_method, created_at)
VALUES (gen_random_uuid(), 'SK-2341', 1450.00, 'FULL', 'MONTHLY', 'MANUAL', CURRENT_TIMESTAMP - INTERVAL '1 month 5 days');
...
VALUES ('SK-2341', 'North', 150, 1800.00, CURRENT_DATE);
INSERT INTO usage_records (customer_id, area, usage, amount, record_date)
VALUES ('SK-2341', 'North', 140, 1650.00, CURRENT_DATE - INTERVAL '1 month');
INSERT INTO usage_records (customer_id, area, usage, amount, record_date)
VALUES ('SK-2341', 'North', 160, 1950.00, CURRENT_DATE - INTERVAL '2 months');
